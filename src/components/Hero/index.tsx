...
import VectorImage from "../../assets/Vector (5).svg";
        ...
        <div className="md:max-w-frame mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
          <div>
            ...
            <div className="w-full flex ">
              <Link
                className="w-full md:w-58 mb-15 md:mb-12 inline-block text-center bg-black hover:bg-black/80 transition-all text-white px-14 py-4 rounded-full hover:animate-pulse"
                to="Shop"
              >
                Shop Now
              </Link>
          ...
          <div className="flex justify-end flex-grow relative">
            <img
              ...
              alt="Hero"
            />
            <img className="w-[500px] h-[500px]" src={MainImage} alt="Main" />
            <img
