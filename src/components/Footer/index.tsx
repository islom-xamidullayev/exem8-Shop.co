...
export default function Footer() {
  return (
    <div className="mainMargin">
      <div className="flex flex-wrap container justify-between items-center  p-10 bg-black mt-10 rounded-3xl">
      ...
      <footer className="mt-12 ">
        <div className="flex flex-wrap justify-between container mx-[30px] mt-10 gap-10">
